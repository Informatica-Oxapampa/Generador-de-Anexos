...
public static class Constantes
{
    ...
    // Las compilaciones de prueba deben publicar una versión informativa con
    // sufijo SemVer (por ejemplo 1.1.0-rc.1). No se deduce por ser un número alto.
    public static bool EsVersionPrueba { get; } =
        (Assembly.GetExecutingAssembly().GetCustomAttribute<AssemblyInformationalVersionAttribute>()?.InformationalVersion ?? "")
        .Split('+')[0].Contains('-', StringComparison.Ordinal);

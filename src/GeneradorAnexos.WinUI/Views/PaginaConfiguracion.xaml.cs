...
public sealed partial class PaginaConfiguracion : UserControl
{
    ...
    public void Refrescar()
    {
        ...
        try
        {
            ...
            InterruptorAutomatico.IsEnabled = true;
            InterruptorAutomatico.IsOn = _preferencias.BuscarActualizaciones;
            TextoBotonBuscar.Text = "Buscar e instalar actualizaciones";
            BotonNotas.Visibility = Visibility.Visible;
            AyudaActualizaciones.Text = "Al iniciar se buscan e instalan versiones nuevas si no hay trabajo sin guardar. También puede comprobarlas con el botón. "
                + "Si tiene cambios sin guardar, podrá guardarlos antes de cerrar. Windows puede solicitar permiso para instalar.";
    ...
    private async Task BuscarAsync()
    {
        ...
        try
        {
            ...
            await AsistenteActualizacion.OfrecerAsync(resultado, instalarDirectamente: true);
            VersionPlantillas.Text = ServicioPlantillas.VersionInstaladaTexto();
        }
        finally
        {
